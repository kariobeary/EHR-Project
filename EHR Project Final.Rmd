...
# Prescription table
pres <- pres %>% 
  dplyr::select(-c("DRUG_CIP7.1","DRUG_BIG_PACK","DRUG_FRM_GAL","DRUG_LAB_ID","PRS.KEY.1","PRS_HP_COD","PRS_NAT"))
...
# From the result, we don't see lots of differences among the 3 models. By BIC, m2 has the lowest BIC and AIC so we chose m2 as our final model.
...
m5 <- lmer(HOSP_DUR~PAT_DPT_GRP+NUM_HOSP+PAT_AGE+PAT_SEX_COD++(NUM_HOSP|PAT_ID), hospitalization, REML=0)
m5
summary(m5)
