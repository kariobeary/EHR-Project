...
```{r Table1}
## Using gtsummary
demographic <- diagnostic %>% distinct(PAT_ID, PAT_SEX_COD, PAT_DPT_GRP, PAT_AGE)

demographic %>% dplyr::select("PAT_DPT_GRP", "PAT_AGE", "PAT_SEX_COD") %>% 
  tbl_summary(by = "PAT_DPT_GRP")

demographic %>% group_by(PAT_DPT_GRP) %>% 
